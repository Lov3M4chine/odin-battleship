...
function attachEventListenerToRandomShipPlacementButton(appContext) {
  appContext.appElements.chooseForMeButton.addEventListener('click', function () {
    return assignRandomShipPlacementForPlayerOne(appContext);
  });
}
...
module.exports = {
  initializeRandomShipPlacementButton: initializeRandomShipPlacementButton
};
...
var _require = __webpack_require__(/*! ./orientationModule */ "./src/modules/orientationModule.js"),
  orientationModule = _require.orientationModule;
...
var _require = __webpack_require__(/*! ./chooseShipPlacementForMe */ "./src/modules/chooseShipPlacementForMe.js"),
  initializeRandomShipPlacementButton = _require.initializeRandomShipPlacementButton;
...
var orientationModule = function () {
  ...
  return {
    ...
    hideOrientationButton: hideOrientationButton
  };
}();
module.exports = {
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var _require = __webpack_require__(/*! ./factories/CreateBattlegrid */ "./src/modules/factories/CreateBattlegrid.js"),
  CreateBattlegrid = _require.CreateBattlegrid;
var _require2 = __webpack_require__(/*! ./factories/CreatePlayers */ "./src/modules/factories/CreatePlayers.js"),
  CreatePlayersForOnePlayerMode = _require2.CreatePlayersForOnePlayerMode;
var _require3 = __webpack_require__(/*! ./initializeBattleMode */ "./src/modules/initializeBattleMode.js"),
  initializeBattleMode = _require3.initializeBattleMode;
var _require4 = __webpack_require__(/*! ./initializePlaceShipsModule.js */ "./src/modules/initializePlaceShipsModule.js"),
  initializePlaceShipsModule = _require4.initializePlaceShipsModule;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return initializePlaceShipsModule.initializePlaceShips(appContext, appContext.playerOne);
        case 5:
          CreateBattlegrid.createBattlegridForPlayerComputer(appContext);
          console.log("Initialization of one player mode complete.");
          console.log(appContext);
...
var _require2 = __webpack_require__(/*! ./modules/errorHandlingModule */ "./src/modules/errorHandlingModule.js"),
  validateAppContext = _require2.validateAppContext;
var appContext = {
  orientation: {
    isVertical: false
  },
